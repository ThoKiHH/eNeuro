...
/**
 * Created by Vincent Modrow on 20/03/2017.
...
public class Network {
    ...
    public Network(int... neuronPerLayer) {
        this.layerArrayList = new ArrayList<>();

        for (int i : neuronPerLayer) {
            layerArrayList.add(new Layer(i));
        }
    }

    public Network(InputFunction inputFunction, ActivationFunction activationFunction, int... neuronPerLayer) {
        this.layerArrayList = new ArrayList<>();

        for (int i : neuronPerLayer) {
            layerArrayList.add(new Layer(i, inputFunction, activationFunction));
        }
    }
    ...
    public void removeLayer(Layer layer) {
        if (!this.hasLayer(layer)) this.layerArrayList.remove(layer);
    }
    ...
    public Layer[] getLayer() {
        return layerArrayList.toArray(new Layer[0]);
    }
}
