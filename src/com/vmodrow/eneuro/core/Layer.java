...
/**
 * Created by Vincent Modrow on 19/03/2017.
...
public class Layer implements java.io.Serializable {
    ...
    public Layer(int numberOfNeurons, InputFunction inputFunction, ActivationFunction activationFunction) {
        if (inputFunction == null) throw new IllegalArgumentException("Inputfunction has to be != to null");
        else if (activationFunction == null)
            throw new IllegalArgumentException("Activationfunction has to be != to null");
        else if (numberOfNeurons < 0) throw new IllegalArgumentException("numberOfNeurons has to be bigger than 0");
        else {
            for (int i = 0; i < numberOfNeurons; i++) {
                this.addNeuron(new Neuron(inputFunction, activationFunction));
            }
        }
    }
