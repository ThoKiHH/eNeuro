...
public class Weight implements java.io.Serializable {
    ...
    /**
     * Value of Weight; How much will the NetInput will be multiplied
     */
    private double value;

    public Weight(double maxDistanceFrom0) {
        this.value = randomizeWeight(maxDistanceFrom0);
    }
     ...
     * @return
     */
    private double randomizeWeight(double maxStreuung) {
        return randomizeWeight(0d, maxStreuung);
    }

    private double randomizeWeight(double minStreuung, double maxStreuung) {
        return minStreuung + Math.random() * (maxStreuung - minStreuung);
    }
