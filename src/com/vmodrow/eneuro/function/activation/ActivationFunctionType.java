...
public enum ActivationFunctionType {
    ...
    /**
     * @return Class of type (Example: ActivationFunctionType.LINEAR -> Linear.class; m1(Class functionClass) -> m1(ActivationFunctionType.LINEAR.getTypeClass){ (ActivationFunction)functionClass.newInstance();}) && (EXAMPLE: ActivationFunction s = Log.class.newInstance();)
     */
    public ActivationFunction getTypeClass() {
        try {
            switch (this) {
                case LINEAR:
                    return Linear.class.newInstance();
                case LOG:
                    return Log.class.newInstance();
                case TANH:
                    return Tanh.class.newInstance();
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
