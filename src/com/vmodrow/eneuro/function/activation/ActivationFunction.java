...
package com.vmodrow.eneuro.function.activation;

/**
 * Created by Vincent Modrow on 22/02/2017.
 * com.vmodrow.eneuro.function.activation
 */
abstract public class ActivationFunction implements java.io.Serializable {

    /**
     * Zwischenspeicher falls getDerivative() aufgerufen wird, damit der output nicht nochmal berechnet werden muss
     */
    protected double output;
    /**
     * Beschreibe die Steigung der Polynomfunktion höchsten ersten Grades
     */
    protected double gradient;
    /**
     * Beschreibe die Konstante der Polynomfunktion höchsten ersten Grades
     */
    protected double constant = 0.0d;


    /**
     * Errechne den Funktionswert an der Stelle netinput;
     *
     * @param netinput
     * @return f(x)
     */
    public abstract double getOutput(double netinput);

    /**
     * Errechne die Steigung an der Stelle netinput;
     *
     * @param netinput
     * @return f'(x)
     */
    public abstract double getDeriverative(double netinput);
}
