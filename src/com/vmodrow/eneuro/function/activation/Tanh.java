...
public class Tanh extends ActivationFunction {
     ...
     *
     * @param netinput
     * @return f(x) -> f(x)=tanh(x) <=> f(x)= (e^x - e^-x) / (e^x + e^-x)
     */
    @Override
    final public double getOutput(double netinput) {
        this.output = (Math.pow(Math.E, netinput) - Math.pow(Math.E, -netinput)) / (Math.pow(Math.E, netinput) + Math.pow(Math.E, -netinput));
        return this.output;
    }
     ...
     *
     * @param netinput
     * @return a -> f'(x)= 1 - ((e^x - e^-x)^2 / (e^x + e^-x)^2)
     */
    @Override
    final public double getDeriverative(double netinput) {
        this.gradient = (1 - (Math.pow(Math.pow(Math.E, netinput) - Math.pow(Math.E, -netinput), (double) 2) / (Math.pow(Math.pow(Math.E, netinput) - Math.pow(Math.E, -netinput), 2))));
