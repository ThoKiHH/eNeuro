...
package com.vmodrow.eneuro.function.input;

import com.vmodrow.eneuro.core.Connection;

/**
 * Created by Vincent Modrow on 22/02/2017.
 * com.vmodrow.eneuro.function.input
 */
public class SumByWeight extends InputFunction {

    double value;

    /**
     * @param inConnection Connection[]
     * @return This function will return the total values of all inputs
     */
    @Override
    public double getOutput(Connection[] inConnection) {
        for (Connection c : inConnection) {
            value += c.getWeightedInput();
        }
        return value;
    }
}
